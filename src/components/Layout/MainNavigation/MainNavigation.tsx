...
const MainNavigation = () => {
  ...
  const sections = [
    ...
    { title: t("navbar.ABOUT_US"), url: "about-us" },
    {
      ...
      submenu: [
        {
          title: t("services:IMPLANT_SURGERY.TITLE"),
          url: "web-design",
        },
        {
          title: t("services:SMILE_DESIGN.TITLE"),
          url: "web-design",
        },
        {
        ...
        {
          title: t("services:TEETH_WHITENING.TITLE"),
          url: "web-design",
        },
        {
          title: t("services:MAXILLOFACIAL_SURGERY.TITLE"),
          url: "web-design",
        },
      ],
    },
